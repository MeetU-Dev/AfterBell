...
const HomePage: React.FC = () => {
    ...
    const handleNewsletterSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showToast('success', 'Subscribed', 'Successfully subscribed to newsletter!');
            setNewsletterEmail('');
        } catch (error) {
            showToast('error', 'Subscription Failed', 'Failed to subscribe. Please try again.');
        } finally {
    ...
    const handleContactSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showToast('success', 'Message Sent', 'Message sent successfully! We\'ll get back to you soon.');
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-slate-400">
                            ...
                            <li><Link to="/privacy" className="hover:text-white transition-colors">Cookies</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-slate-800 text-center">
                    <p className="text-slate-400">
                        © {new Date().getFullYear()} AfterBell. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
