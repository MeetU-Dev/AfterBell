...
const skills = [
  {
    ...
    steps: [
      { title: 'Understanding Money Basics', description: 'Learn the fundamentals of income, expenses, and why budgeting matters.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Budget worksheet template', 'Income tracking sheet'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Overcoming Stage Fright', description: 'Understand why we get nervous and learn techniques to stay calm.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Breathing exercises', 'Nervousness checklist'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Kitchen Safety & Tools', description: 'Learn essential kitchen safety rules and must-have tools.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Kitchen safety checklist', 'Essential tools guide'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Understanding Your Camera', description: 'Learn the basic functions of any camera or smartphone.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: [] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Privacy Settings', description: 'Learn to configure your privacy settings across platforms.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: [] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Finding Your Voice', description: 'Discover your unique writing style and perspective.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: [] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Understanding Your Time', description: 'Analyze how you currently spend your time.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: [] },
  ...
  },
  {
    ...
    steps: [
      { title: 'What is Programming?', description: 'Understand what coding is and how it powers technology.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: [] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Understanding Stress', description: 'Learn what stress is and how it affects your body and mind.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Stress symptoms checklist'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Understanding Self-Esteem', description: 'Learn what self-esteem is and how it shapes your life.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Self-esteem reflection worksheet'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Understanding Relationships', description: 'Learn what makes relationships healthy or unhealthy.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Healthy vs unhealthy relationship checklist'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Understanding Anxiety', description: 'Learn what anxiety is and why it happens.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Anxiety symptoms guide'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'The Decision-Making Process', description: 'Learn a step-by-step framework for making decisions.', duration: '5 min', type: 'video', content: 'https://www.youtube.com/embed/4vGcH0Bk3hg', resources: ['Decision-making worksheet'] },
